...
#### Compute k-mers with Biostrings and Jellyfish
...
##### Generate histogram of 1-, 2- and 3-mer frequencies as probabilities
...
![Figure Caption: Number of k-mers for a given probability of occurence within the given dataset. As k increases, the inverse relationship between the probability of a k-mer occuring and k-mer frequency becomes more clear. In other words, as k increases, the probability of a dominant pattern decreases.](./figs/small_mer_histogram.png)
